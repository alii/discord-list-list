	...
	if (props.name !== "Discord.style")
		...
		return (
			<button
				...
				className="block p-4 space-y-2 text-left transition duration-200 ease-in-out bg-gray-700 rounded-md bg-opacity-5 dark:bg-opacity-20 hover:bg-opacity-10 hover:text-white hover:bottom-1 focus:outline-none"
			>
